      ...
      <div class="col-sm-12 col-md-12">
        <div class="card">
          <div class="card-header">
            <strong>网站基本配置</strong> <small></small>
          </div>

          <div class="card-block">
            <el-form ref="form" :model="form" label-width="80px" id="form">
            <div class="form-group row">
              <label for="text-input" class="col-md-1 form-control-label">网站标题</label> 
              <div class="col-md-11">
            ...
            <div class="form-group row">
              <label for="text-input" class="col-md-1 form-control-label">网站LOGO</label> 
              <div class="col-md-11">
                <el-button size="small" @click="dialogPhotoVisible = true">从图片库选择</el-button>
              </div>
            </div>
            <div class="form-group row">
              <label for="text-input" class="col-md-1 form-control-label">关键词</label> 
              <div class="col-md-11">
            ...
            <div class="form-group row">
              <label for="text-input" class="col-md-1 form-control-label">简介</label> 
              <div class="col-md-11">
                <el-input type="textarea" :rows="4" v-model="form.desc"></el-input>
              </div>
            </div>
            <div class="form-group row">
              <label for="text-input" class="col-md-1 form-control-label">版权信息</label> 
              <div class="col-md-11">
                <el-input type="textarea" :rows="2" v-model="form.desc"></el-input>
              </div>
            </div>
            <div class="form-group row">
              <label for="text-input" class="col-md-1 form-control-label">访问统计</label> 
              <div class="col-md-11">
                <el-input type="textarea" :rows="2" v-model="form.desc"></el-input>
              </div>
            </div>
            <div class="form-group row">
              <label for="text-input" class="col-md-1 form-control-label">关闭网站</label> 
              <div class="col-md-11">
              <template>
                <el-radio class="radio" v-model="form.siteViewStatus" label="1">是</el-radio>
                <el-radio class="radio" v-model="form.siteViewStatus" label="2">否</el-radio>
              </template>
              </div>
            </div>
            <div class="form-group row">
              <label for="text-input" class="col-md-1 form-control-label">关闭原因</label> 
              <div class="col-md-11">
                <el-input type="textarea" :rows="2" v-model="form.desc"></el-input>
              </div>
            </div>
